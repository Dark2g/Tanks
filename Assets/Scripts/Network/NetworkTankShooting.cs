...
/// The owning client charges the shot locally for responsive UI feedback,
/// then sends a Fire RPC to the server which spawns the shell authoritatively.
/// </summary>
public class NetworkTankShooting : NetworkBehaviour
{
    ...
    private void RequestFireServerRpc(float launchForce)
    {
        ...
        // Instantiate and spawn the shell on the server so NGO replicates it.
